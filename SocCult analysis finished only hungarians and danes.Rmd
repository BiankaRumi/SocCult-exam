---
title: "Analysis SocCult only hun and dane"
output: 
  md_document:
...
combined<-subset(combined,NativeCountry=="Hungary"| NativeCountry=="Ungarn" |NativeCountry=="Denmark" |NativeCountry=="Danmark")
...
ggplot(combined, aes(CPI_native, q_data))+geom_point()+geom_smooth()
