...
```{r}
combined<-merge(d_long,q_long, by="ID", "Age", "Gender", "Education", "CogSci", "CPI_native","CPI_current", "NativeCountry", "CurrentCountry", "Years_Current")
