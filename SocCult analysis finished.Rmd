...
ggplot(combined, aes(CPI_native, q_data, fill=CPI_native))+geom_bar(stat="summary", fun.y="mean")+ggtitle("Effect of CPI on Interpersonal Trust (questionnaire)")+labs(x="Corruption Perception Index for native country", y="Mean score on Trust Questionnaire")

ggplot(combined, aes(CPI_native, q_data))+geom_point()+geom_smooth()+ggtitle("Effect of CPI on Interpersonal Trust (questionnaire)")+labs(x="Corruption Perception Index for native country", y="Score on Trust Questionnaire")
